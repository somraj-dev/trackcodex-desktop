...
export const CandidateCard = ({ application, onClick }: { application: any; onClick?: () => void }) => {
    ...
    return (
        <div
            ...
            {...attributes}
            onClick={onClick}
            className="bg-[#11141A] border border-[#1E232E] rounded-xl p-4 shadow-sm hover:border-primary/50 cursor-grab active:cursor-grabbing mb-3"
        >
            <div className="flex items-center gap-3 mb-3">
                <img src={application.applicant.avatar} className="size-8 rounded-lg bg-[#0A0D14] object-cover" />
                <div>

...
const CollaborativeDiffViewer: React.FC<CollaborativeDiffViewerProps> = ({
  ...
  return (
    <div className="h-[500px] border border-[#1E232E] rounded-lg overflow-hidden bg-[#0A0D14]">
      <div className="bg-[#11141A] px-4 py-2 border-b border-[#1E232E] flex justify-between items-center">
        ...
        <div className="flex -space-x-2">
          ...
          {presence.length > 5 && (
            <div className="size-6 rounded-full border-2 border-[#161b22] bg-[#11141A] flex items-center justify-center text-[10px] text-[#8b949e]">
              +{presence.length - 5}
            </div>
          )}
        </div>

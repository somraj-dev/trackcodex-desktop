        ...
        <div className="flex items-center gap-3">
          {currentContext === "personal" ? (
            profile.avatar ? (
              ...
              <div className="size-8 rounded-full border border-gh-border bg-primary/20 flex items-center justify-center text-primary font-bold text-sm">
          ...
          <div>
            <div className="text-sm font-bold text-gh-text group-hover:text-primary transition-colors">
              {currentContext === "personal" ? (profile.name || profile.username) : strataName}
            </div>

...
const ActivityFeed = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {activities.length === 0 ? (
        <div className="p-8 text-center bg-[#11141A] border border-[#1E232E] rounded-md text-gh-text-secondary">
        ...
        activities.map((item) => (
          <div
            key={item.id}
            className="flex gap-3 p-4 bg-[#11141A] border border-[#1E232E] rounded-md"
          >

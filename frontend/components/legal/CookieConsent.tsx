...
export const CookieConsent: React.FC<CookieConsentProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-[#11141A] border-t border-[#1E232E] shadow-2xl animate-slide-up">
      {!showSettings ? (
        ...
        <div className="max-w-2xl mx-auto bg-[#0A0D14] p-6 rounded-lg border border-[#1E232E]">

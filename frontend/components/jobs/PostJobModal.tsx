        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="space-y-4">
            <input
              ...
              className="w-full bg-[#0A0D14] border border-[#1E232E] rounded-xl px-4 py-3 text-white focus:ring-1 focus:ring-primary outline-none"
            />
            <textarea
              required
              ...
              className="w-full bg-[#0A0D14] border border-[#1E232E] rounded-xl px-4 py-3 text-white h-32 resize-none outline-none"
            />
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="bg-[#0A0D14] border border-[#1E232E] rounded-xl px-4 py-3 text-white outline-none"
              />
              <select
                value={formData.type}
                onChange={e => setFormData({ ...formData, type: e.target.value as any })}
                className="bg-[#0A0D14] border border-[#1E232E] rounded-xl px-4 py-3 text-white outline-none appearance-none"
              >

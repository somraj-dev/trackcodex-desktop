      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <span className="text-[#8b949e]">
            ...
            <code className="bg-[#11141A] px-1 rounded">main</code> from{" "}
            <code className="bg-[#11141A] px-1 rounded">feature/dark-mode</code>
          </span>
        </div>
      </div>

      {/* Tabs */}
      <div className="border-b border-[#1E232E] mb-6 flex gap-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              <div className="lg:col-span-3 space-y-4">
                <div className="flex gap-4">
                  ...
                  />
                  <div className="flex-1 bg-[#0A0D14] border border-[#1E232E] rounded-lg">
                    <div className="bg-[#11141A] p-2 px-4 border-b border-[#1E232E] text-sm flex justify-between rounded-t-lg">
                      <div>
                ...
                <div className="flex items-center gap-4 ml-5 relative pb-8 border-l-2 border-[#1E232E] pl-8">
                ...
                {/* Merge Box */}
                <div className="border border-[#1E232E] rounded-lg p-4 bg-[#11141A] mt-8">

  ...
  return (
    <div className="flex flex-col gap-2 group cursor-pointer" onClick={onClick}>
      ...
      >
        ...
        {isActive && (
          <div className="absolute bottom-2 right-2 size-5 bg-primary rounded-full flex items-center justify-center text-white shadow-sm">
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <section>
        <div className="flex items-center justify-between p-4 border border-gh-border rounded-md bg-gh-bg-secondary">
          ...
          >
            <div
              className={`absolute top-1 size-3 bg-white rounded-full transition-all ${isHighContrast ? "left-6" : "left-1"}`}
            />
          </button>
        </div>
      </section>

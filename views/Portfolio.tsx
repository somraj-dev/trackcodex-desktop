            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <div className="flex items-start gap-8">
                        <div className="flex-1">
                            ...
                            <p className="text-gh-text-secondary mb-4 leading-relaxed">
                ...
                <div className="mb-12">
                    ...
                    <div className="flex gap-4 mb-6">
                        <button className="flex items-center gap-2 px-4 py-2 bg-gh-bg-secondary rounded-md text-sm text-gh-text-secondary hover:bg-gh-bg-tertiary transition-colors">
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4">
                        {skills.map((skill, index) => (
                            <div
                                key={index}
                                className="flex items-center gap-3 px-4 py-3 bg-gh-bg-secondary border border-gh-border rounded-md hover:border-blue-500 transition-colors cursor-pointer"
                            >
                ...
                <div className="mb-12">
                    <h2 className="text-2xl font-semibold mb-6 flex items-center gap-2">
                        Skill Radar
                        <span className="text-xs font-normal text-gh-text-secondary border border-gh-border px-2 py-0.5 rounded-full">Beta</span>
                    </h2>
                ...
                <div>
                    ...
                    {/* Project Tabs */}
                    <div className="flex gap-6 mb-6 border-b border-gh-border">
                        <button

...
const OfferHighlight = ({ value, label, sublabel, icon }: { value: string; label: string; sublabel: string; icon: string; }) => (
    <div className="bg-[#0A0A0A] p-5 rounded-xl border border-[#1A1A1A]">
...
const OfferAcceptanceView = () => {
    ...
    return (
        <div className="min-h-screen bg-[#000000] text-slate-300 font-display p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Document Viewer */}
                        <div className="bg-[#0A0A0A] border border-gh-border rounded-xl overflow-hidden">
                    ...
                    <aside className="space-y-8">
                        <div className="bg-[#0A0A0A] p-6 rounded-xl border border-gh-border">

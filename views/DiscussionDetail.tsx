        ...
        {["👍", "👎", "😄", "🎉", "❤️", "🚀", "👀"].map((emoji) => {
          ...
          return (
            <button
              ...
              className={`px-2 py-1 rounded-full border text-xs transition-all flex items-center gap-1 ${
                count > 0
          ...
          <div className="mt-8 bg-gh-bg-secondary border border-gh-border rounded-lg p-4">
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className="px-6 py-2 bg-primary text-white rounded-md font-bold hover:bg-opacity-90 disabled:opacity-50"
              >

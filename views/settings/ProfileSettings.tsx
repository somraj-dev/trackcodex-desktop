...
const ProfileSettings = () => {
  ...
  return (
    <div className="max-w-[1000px] text-[#c9d1d9]">
      ...
      <div className="border-b border-[#1A1A1A] mb-8"></div>
        ...
        <div className="md:col-span-8 space-y-6">
              ...
              {(profile.socialLinks || ["", "", "", ""]).map((link, idx) => {
                ...
                return (
                  <div key={idx} className="relative">
                    ...
                    />
                    {platform && (
                      <span className="absolute right-3 top-2 text-xs text-[#8b949e] bg-[#111111] px-2 py-0.5 rounded border border-[#1A1A1A]">
                        {platform.name}
                      </span>
                    )}
                  </div>
          ...
          <div className="flex items-start gap-2">
            <input
              ...
              onChange={handleChange}
              className="mt-1 bg-[#000000] border-[#1A1A1A] rounded text-blue-500 focus:ring-0"
            />
            <div>
              <label htmlFor="displayLocalTime" className="text-sm font-semibold text-white flex items-center gap-2">
                ...
                {profile.displayLocalTime && (
                  <span className="text-xs font-normal text-[#8b949e] bg-[#111111] px-2 py-0.5 rounded-full border border-[#1A1A1A]">
            ...
            {profile.orcidId ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-[#111111] hover:bg-[#30363d] hover:text-red-400 border border-[#1A1A1A] rounded-md text-sm font-semibold text-[#c9d1d9] transition-colors"
                >
                  Disconnect
                </button>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-grow flex items-center justify-center gap-2 px-3 py-1.5 bg-[#111111] hover:bg-[#30363d] border border-[#1A1A1A] rounded-md text-sm font-semibold text-[#c9d1d9] transition-colors"
                >
        ...
        <div className="md:col-span-4 pl-0 md:pl-8">
          ...
          <div className="relative group w-fit">
            <img
              src={profile.avatar}
              alt="Profile"
              className="size-48 rounded-full border border-[#1A1A1A]"
            />
            <button
              onClick={() => fileInputRef.current?.click()}
              className="absolute bottom-2 left-0 bg-[#111111] hover:bg-[#30363d] border border-[#1A1A1A] text-[#c9d1d9] text-xs font-semibold px-3 py-1.5 rounded-md shadow-sm flex items-center gap-2 transition-colors"
            >
      ...
      <div className="mt-12 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-2">
              <input type="checkbox" className="mt-1 bg-[#000000] border-[#1A1A1A] rounded text-blue-500 focus:ring-0" />
              <div>
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" defaultChecked className="mt-1 bg-[#000000] border-[#1A1A1A] rounded text-blue-500 focus:ring-0" />
              <div>
            ...
            <button className="px-3 py-1.5 bg-[#111111] hover:bg-[#30363d] border border-[#1A1A1A] rounded-md text-sm font-semibold text-[#c9d1d9] transition-colors mt-2">
              Update preferences
            </button>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="p-4 border border-[#1A1A1A] rounded-md bg-[#000000]">

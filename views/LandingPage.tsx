    ...
    <div className="landing-container min-h-screen w-full flex bg-[#f5f5f7] relative overflow-hidden font-sans">
      ...
      <main className="relative z-10 w-full max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center justify-between px-6 py-12 lg:p-20 gap-16">
        ...
        <div className="flex-1 flex flex-col items-start justify-center max-w-xl">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-[90%]">
          ...
          <div className="flex items-center gap-4 mb-12">
            <button
              ...
              className="px-8 py-3.5 rounded-full bg-gray-900 text-white font-medium hover:bg-gray-800 transition-colors shadow-lg shadow-gray-200/50"
            >
              Start for Free
            </button>
            <a
              href="https://github.com/somraj-dev/trackcodex-desktop/releases/latest"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-3.5 rounded-full bg-white text-gray-900 font-medium hover:bg-gray-50 transition-colors border border-gray-200 shadow-sm flex items-center gap-2"
            >

...
export const profileService = {
  ...
  async getProfileByIdOrUsername(idOrUsername: string): Promise<UserProfile> {
    ...
    try {
      const response = await apiAxios.get(`${API_BASE_URL}/users/${idOrUsername}`, {
  ...
  async unfollowUser(userId: string): Promise<void> {
    ...
    try {
      await apiAxios.delete(`${API_BASE_URL}/users/${userId}/follow`, {
        withCredentials: true,
      });
      this.simulateUnfollow();
    } catch (error: unknown) {
  ...
  async getTrendingUsers(): Promise<UserProfile[]> {
    try {
      const response = await apiAxios.get(`${API_BASE_URL}/users/trending`, {
        withCredentials: true,
      });
      return response.data || [];
    } catch (error) {
  ...
  async getSuggestedUsers(): Promise<UserProfile[]> {
    try {
      const response = await apiAxios.get(`${API_BASE_URL}/users/suggested`, {
        withCredentials: true,
      });
      return response.data || [];
    } catch (error) {
  ...
  async searchUsers(query: string): Promise<UserProfile[]> {
    try {
      const response = await apiAxios.get(`${API_BASE_URL}/users/search`, {
        params: { q: query },
        withCredentials: true,
      });

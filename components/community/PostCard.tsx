...
const PostCard: React.FC<{ post: any }> = ({ post }) => {
  ...
  return (
    <div className={`bg-[#11141A] border border-[#1E232E] rounded-2xl p-6 hover:border-[#8b949e] transition-all group shadow-sm relative ${post.moderation === 'FLAGGED' ? 'opacity-50 grayscale' : ''}`}>
      ...
      <div className="mb-6">
        ...
        {post.codeSnippet && (
          <div className="rounded-xl border border-[#1E232E] overflow-hidden bg-[#0A0D14] mb-4">
            <div className="bg-[#11141A] px-4 py-2 border-b border-[#1E232E] flex items-center justify-between">
      ...
      {post.linkedEntity && (
        <div
          ...
          className="mb-6 p-4 bg-[#0A0D14] border border-[#1E232E] rounded-xl flex items-center justify-between group/entity cursor-pointer hover:border-primary/50 transition-all"
        >
      ...
      <div className="flex items-center justify-between pt-4 border-t border-[#1E232E]">
        <div className="flex items-center gap-4">
          <div className="flex items-center bg-[#0A0D14] border border-[#1E232E] rounded-lg p-1">
            <button
      ...
      {/* Comment Section */}
      {showComments && (
        <div className="mt-6 pt-6 border-t border-[#1E232E] animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="flex items-start gap-3 mb-6">
            <img
              src={profileService.getProfile().avatar}
              alt="Current user avatar"
              className="size-8 rounded-full border border-[#1E232E] object-cover shrink-0"
            />
            <div className="flex-1 space-y-3">
              ...
              <textarea
                ...
                className="w-full bg-[#0A0D14] border border-[#1E232E] rounded-xl p-3 text-sm text-slate-200 placeholder:text-slate-600 focus:ring-1 focus:ring-primary outline-none resize-none min-h-[60px]"
              />

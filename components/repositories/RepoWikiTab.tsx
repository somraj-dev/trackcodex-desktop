    ...
    <div className="flex gap-8 p-6">
      ...
      <div className="w-[240px] text-sm hidden md:block">
            ...
            <li
              ...
              className={`px-2 py-1.5 rounded-md cursor-pointer ${
                activeSlug === page.slug
                  ? "bg-[#111111] font-medium border-l-[3px] border-[#f78166]"
        ...
        <div className="border-t border-[#1A1A1A] pt-4">
          ...
          <div className="flex items-center bg-[#000000] border border-[#1A1A1A] rounded-md overflow-hidden">
            <input
              type="text"
          ...
          {!isEditing ? (
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1.5 bg-[#111111] border border-[#1A1A1A] text-[#c9d1d9] rounded-md text-sm font-bold hover:bg-[#30363d] transition-colors"
              >
                Cancel
              </button>
              <button
        ...
        {loading ? (
          ...
          <>
            ...
            <textarea
              ...
              className="w-full h-[500px] bg-[#000000] border border-[#1A1A1A] rounded-md p-4 text-[#c9d1d9] font-mono focus:border-[#58a6ff] focus:outline-none resize-none"

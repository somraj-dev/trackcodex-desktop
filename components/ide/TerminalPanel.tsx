...
const TerminalPanel = ({ workspaceId = 'default', onClose, onMaximize, logs = [] }: { workspaceId?: string; onClose?: () => void; onMaximize?: () => void; logs?: string[] }) => {
    ...
    return (
        <div className="h-full flex flex-col bg-[#1e1e1e] border-t border-[#1A1A1A] font-mono text-sm group">
            <div className="flex items-center justify-between px-4 border-b border-[#1A1A1A] h-[30px] shrink-0 bg-[#1e1e1e]">

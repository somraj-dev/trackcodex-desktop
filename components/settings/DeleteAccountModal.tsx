...
export const DeleteAccountModal: React.FC<DeleteAccountModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-[#0A0A0A] border border-[#1A1A1A] rounded-lg shadow-xl p-6">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-[#000000] border border-[#1A1A1A] rounded-md text-[#c9d1d9] focus:border-[#58a6ff] focus:ring-1 focus:ring-[#58a6ff] outline-none"
        ...
        <button
          ...
          className={`w-full py-2 px-4 rounded-md font-bold text-white transition-all ${
            confirmText === user?.username && !isDeleting
              ...
              : "bg-[#111111] text-[#8b949e] cursor-not-allowed"
          }`}
        >
